		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<div class="box-register">
					<form name="registration" id="registration"  method="post">
						<fieldset>
							...
							<div class="form-actions">
								...
								Nous faire parvenir <i class="fa fa-arrow-circle-right"></i>
								</button>
							</div>
						</fieldset>
					</form>
					...
					<div class="copyright">
						&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> Clinique 221</span>. <span>Tout droits reserves</span>
					</div>
