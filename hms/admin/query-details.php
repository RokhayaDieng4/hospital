				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Détails de la requête</h1>
																	</div>
								<ol class="breadcrumb">
						...
						<div class="container-fluid container-fullw bg-white">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">Gerer <span class="text-bold">Détails de la requête</span></h5>
...
<form name="query" method="post">
	...
	<tr>
												<th>ARemarque de l'administrateur</th>
