				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">gérer les utilisateurs</h1>
																	</div>
								<ol class="breadcrumb">
									<li class="active">
						...
						<div class="container-fluid container-fullw bg-white">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">Gerer<span class="text-bold">Utilisateurs</span></h5>
									...
									<table class="table table-hover" id="sample-table-1">
										<thead>
											<tr>
												<th class="center">#</th>
												<th>Nom complet</th>
												<th class="hidden-xs">Adress<s/th>
												<th>Ville</th>
												<th>Genre </th>
												<th>Email </th>
												<th>Date Creation </th>
