...
$_SESSION['msg']="Doctor Specialisation mis à jour avec succès!!";
} 
						...
						<section id="page-title">
							<div class="row">
								...
								<ol class="breadcrumb">
									...
									<li class="active">
										<span>Modifier la spécialisation du docteur</span>
									</li>
								</ol>
							</div>
						</section>
										...
										<div class="col-lg-6 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Modifier la spécialisation du docteur</h5>
												</div>
								...
								<?php echo htmlentities($_SESSION['msg']="");?></p>	
													<form role="form" name="dcotorspcl" method="post" >
														<div class="form-group">
															...
															Modifier la spécialisation du docteur
															</label>
