...
if($sql)
{
echo "<script>alert('Détails du médecin mis à jour avec succès');</script>";
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Modifier les détails du médecin</h5>
												</div>
...
<p><b>Profil Reg. Date: </b><?php echo htmlentities($data['creationDate']);?></p>
