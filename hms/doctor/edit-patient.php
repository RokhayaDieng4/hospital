...
if($sql)
{
echo "<script>alert('Informations sur le patient mises à jour avec succès');</script>";
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Ajouter un patient</h1>
</div>
<ol class="breadcrumb">
<li class="active">
...
<div class="form-group">
              ...
              <input type="radio" name="gender" id="gender" value="Female" checked="true">Femmme
