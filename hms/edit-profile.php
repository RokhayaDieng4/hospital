...
{
?>
<h4><?php echo htmlentities($data['fullName']);?> profil</h4>
<p><b>Profil Reg. Date: </b><?php echo htmlentities($data['regDate']);?></p>
...
<div class="form-group">
					...
					<a href="change-emaild.php">Mettez à jour votre identifiant de messagerie</a>
														</div>
